...
@ToString
@Slf4j
public class DetalleAlumnoCapacidad {
    ...
    private String alnocIndActi;
    private String notaCapacidad;
    private String notaCapacidadDesc;


    public static DetalleAlumnoCapacidad convertTupleToEntity(Object queryResult) {
        log.info("Entrando a DetalleAlumnoCapacidad - convertTupleToEntity");
        Object[] aux = (Object[]) queryResult;
        log.info("Object [] - {}", Arrays.stream(aux).toList());
        return DetalleAlumnoCapacidad.builder()
                ...
                .idCapacidad(String.valueOf(aux[24]))
                .codCapacidad(String.valueOf(aux[25]))
                .capacidadDesc(String.valueOf(aux[26]))
                .alnocIndActi(String.valueOf(aux[27]))
                .notaCapacidad(String.valueOf(aux[28]))
                .notaCapacidadDesc(String.valueOf(aux[29]))
                .build();
